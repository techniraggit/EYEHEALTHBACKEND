...
business_urls = [
    ...
    path(
        ...
        business.BusinessDetailView.as_view(),
        name="business_detail_view",
    ),
    ...
    path(
        "edit-store/<uuid:store_id>",
        business.EditStoreView.as_view(),
        name="edit_store_view",
    ),
    path(
        "delete-store/<uuid:store_id>",
    ...
    path(
        ...
        business.UpdateAppointmentStatusView.as_view(),
